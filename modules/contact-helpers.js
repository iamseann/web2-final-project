...
function sendEmailNotification(message, callback) {
    ...
    const DOMAIN = "seanalvarado.westernstudent.com";
    const EMAIL_SERVER = "mail." + DOMAIN;
    const EMAIL_ADDRESS = "_mainaccount@" + DOMAIN;
    const EMAIL_PASSWORD = "f0XAhIU0Rw6c"; 
    ...
    const emailOptions = {
        ...
        text: message // This now uses the 'message' variable passed from app.js
    };

    transporter.sendMail(emailOptions, callback);
}
// This "exposes" the functions so app.js can see them
module.exports = {
  isValidContactFormSubmit,
